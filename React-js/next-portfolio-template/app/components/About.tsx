        ...
        <div className="flex flex-col lg:flex-row items-start gap-16">
          ...
          >
            ...
            <div className="space-y-6 text-gray-600 dark:text-gray-300">
              <p>
                Hello! I&apos;m Farhan Assegaf, an Odoo Developer at HashMicro with 1.5 years of experience
                in crafting digital solutions that make a difference.
              </p>
              
              <p>
                Based in Jakarta, I&apos;ve had the opportunity to work with diverse clients
                ranging from startups to established enterprises. My expertise lies in
                building scalable Odoo applications that combine functionality with exceptional user experience.
              </p>
              
              <p>
                When I&apos;m not coding, you&apos;ll find me exploring new Odoo modules, contributing
                to open-source projects, or sharing knowledge with the Odoo community.
              </p>
            </div>
